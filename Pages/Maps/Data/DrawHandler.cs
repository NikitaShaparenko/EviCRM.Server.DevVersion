...
namespace EviCRM.Server.Pages.Maps.Data
{
    public class DrawHandler : IDisposable
    {
        ...
        readonly Models.Rectangle _rectangle = new Models.Rectangle();
        ...
        void UpdateShape(Models.LatLng latLng)
        {
            switch (_drawState)
            {
        ...
        void UpdateRectangle(Models.LatLng latLng)
        {
        ...
        void UpdateCircle(Models.LatLng latLng)
        {
        ...
        void UpdatePolygon(Models.LatLng latLng)
        {
