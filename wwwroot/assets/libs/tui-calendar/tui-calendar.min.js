        ...
        var l = n(0),
            ...
            c = {
                ...
                "milestoneTitle-tmpl": function() {
                    return '<span class="' + r.classname("left-content") + '">Промежуточная точка</span>'
                },
                "task-tmpl": function(e) {
                    return "#" + e.title
                },
                "taskTitle-tmpl": function() {
                    return '<span class="' + r.classname("left-content") + '">Задача</span>'
                },
                "alldayTitle-tmpl": function() {
                    return '<span class="' + r.classname("left-content") + '">Весь день</span>'
                },
