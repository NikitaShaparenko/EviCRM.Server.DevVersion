...
! function(e, t) {
    ...
    function k() {
        var e = document.getElementById("calendarTypeName"),
            ...
            n = l.getOptions(),
            a = l.getViewName(),
            o = "day" === a ? (a = "1 день", "calendar-icon ic_view_day") : "week" === a ? (a = "Неделя", "calendar-icon ic_view_week") : 2 === n.month.visibleWeeksCount ? (a = "2 недели", "calendar-icon ic_view_week") : 3 === n.month.visibleWeeksCount ? (a = "3 недели", "calendar-icon ic_view_week") : (a = "Месяц", "calendar-icon ic_view_month");
